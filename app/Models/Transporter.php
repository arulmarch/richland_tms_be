...
class Transporter extends Model
{
    ...
    protected $table = 'tb_transporters';
     ...
     */
    protected $fillable = [
        'id', 'transporter_id', 'name', 'address1', 'address2', 'city', 'postal_code', 'phone', 'fax', 'transport_mode', 'payment_term', 
        'additional_information', 'created_by', 'updated_by', 'created_date', 'updated_date', 'deleted', 'id_company'
    ];
