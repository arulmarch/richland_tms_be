...
class ClientRate extends Model
{
    ...
    protected $table = 'tb_client_rates';
     ...
     */
    protected $fillable = [
        'id', 'client_id', 'transporter_id', 'origin_id', 'destination_id', 'type_id', 'status',
        'currency', 'rate_type', 'vehicle_rate', 'min_weight', 'remark', 'created_by', 'updated_by', 
        'created_date', 'updated_date', 'deleted', 'id_company'
    ];
