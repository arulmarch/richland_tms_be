...
class Pod extends Model
{
     ...
     */
    protected $fillable = [
        'id', 'transport_order_id', 'pending_code', 'code', 'pod_time', 'receivetime', 'doc_reference', 'receiver', 
        'remark', 'submit_time', 'created_by', 'updated_by', 'updated_date', 'deleted', 'id_company', 'status'
    ];
