...
class Owned extends Model
{
     ...
     */
    protected $fillable = [
        'id', 'name_pt', 'address_pt', 'account_bank_name', 'account_name', 'account_bank_number', 'director', 'telp_pt', 'taxable', 'created_by', 'updated_by', 'created_date', 'updated_date', 'deleted', 'id_company'
    ];
