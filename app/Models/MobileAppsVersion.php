...
class MobileAppsVersion extends Model
{

    protected $table = 'tb_mobile_apps_version';
     ...
     */
    protected $fillable = [
        'id', 'code_version', 'name_version', 'type_platform', 'desc_version', 'file', 'priority',
        'created_by', 'updated_by', 'created_date', 'updated_date', 'deleted', 'id_company'
    ];
